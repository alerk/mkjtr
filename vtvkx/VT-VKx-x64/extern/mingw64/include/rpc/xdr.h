...
/*peze */
#define XDR_GETINT32(xdrs, longp)			\
	(*(xdrs)->x_ops->x_getlong)(xdrs, longp)

#define XDR_PUTINT32(xdrs, longp)			\
	(*(xdrs)->x_ops->x_putlong)(xdrs, longp)
...
DllExport bool_t xdr_int64_t (XDR *__xdrs, int64_t *__ip) ;
DllExport bool_t xdr_uint64_t (XDR *__xdrs, uint64_t *__up) ;
