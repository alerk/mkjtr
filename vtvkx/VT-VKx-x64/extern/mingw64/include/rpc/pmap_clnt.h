...
DllExport bool_t pmap_set (const u_long __program, const u_long __vers,
			int __protocol, u_short __port) ;
DllExport bool_t pmap_unset (const u_long __program, const u_long __vers)
     ;
DllExport struct pmaplist *pmap_getmaps (struct sockaddr_in *__address) ;
DllExport enum clnt_stat pmap_rmtcall (struct sockaddr_in *__addr,
				    const u_long __prog,
				    const u_long __vers,
				    const u_long __proc,
				    xdrproc_t __xdrargs,
				    ...
				    u_long *__port_ptr) ;
DllExport enum clnt_stat clnt_broadcast (const u_long __prog,
				      const u_long __vers,
				      const u_long __proc, xdrproc_t __xargs,
				      caddr_t __argsp, xdrproc_t __xresults,
				      caddr_t __resultsp,
				      resultproc_t __eachresult) ;
DllExport u_short pmap_getport (struct sockaddr_in *__address,
